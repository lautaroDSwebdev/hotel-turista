...
export const dataES = {
  ...
  CONTENT: {
    ...
    about: {
      ...
      paragraphs: [
        "Hotel Turista ha recibido a viajeros, families y aventureros que buscan una estadía cómoda y relajada en Tandil. Nuestro hotel destaca por brindar el carácter de la hospitalidad local combinado con una ubicación inmejorable.",
      ...
      gallery: [
        {
          ...
          alt: "Habitación cómoda matrimonial",
          span: "md:col-span-2 md:row-span-2",
        },
        {
          src: "/images/gallery-terrace.png",
          alt: "Área de comedor e interior del hotel",
          span: "",
        },
        {
          src: "/images/gallery-bath.png",
          alt: "Baño impecable y equipado",
          span: "",
        },
        {
          src: "/images/gallery-garden.png",
          alt: "Fachada e ingresos al hotel",
          span: "md:col-span-2",
        },
        {
          src: "/images/gallery-breakfast.png",
          alt: "Desayuno servido por la mañana",
          span: "",
        },
        {
          src: "/images/amenity-pool.png",
          alt: "Detalles y calidez de nuestras instalaciones",
          span: "",
        },
      ],
    },
    ...
    location: {
      title: "Ubicación",
      title1: "Encuéntranos en el centro de Tandil",
      description:
    ...
    guestbook: {
      ...
      subtitle:
        "Comparte un recuerdo de tu estadía o lee la experiencia de otros visitantes.",
      form: {
    ...
    inquiries: {
      title: "Consultas",
      title1: "Comienza a planificar tu estadía",
      description:
      ...
      form: {
        ...
        messagePlaceholder:
          "Cuéntanos sobre tu viaje o cualquier petición especial…",
